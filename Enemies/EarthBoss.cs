...
{
    class EarthBoss : Enemy
    {
        public static Texture2D texture;
        public static Texture2D bulletTexture;
        public static Texture2D earthElementalTexture;
        private int timer = 0;
        ...
        public EarthBoss(Vector2 pos, Vector2 c) : base(pos, 40f)
        {
            boss = true;
            life = 3;
            center = c;
        ...
        public static void LoadContent(ContentManager loader)
        {
            ...
            earthElementalTexture = loader.Load<Texture2D>("EarthElemental");
        }
    }
}
